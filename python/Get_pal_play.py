...
print('''This is the script that retrieves the AMPS forecasts. It checks for the \n\r\
...
#            'mamsler@uab.edu']
        ...
        url_3km = 'http://www2.mmm.ucar.edu/rt/amps/wrf_plots/' + today1 +'00/antpen/meteogram/plm.png'
        forecast_3km = 'plm_3km.png'
        
        url_9km = 'http://www2.mmm.ucar.edu/rt/amps/wrf_plots/'+today1+'00/palmer/meteogram/plm.png'
        forecast_9km = 'plm_9km.png'
        
        url_10km = 'http://www2.mmm.ucar.edu/rt/amps/wrf_plots/'+today1+'00/10km/meteogram/plm.png'
        forecast_10km = 'plm_10km.png'
        
        print('Getting the images...')
        get_image(url_3km, path+forecast_3km)
        get_image(url_9km, path+forecast_9km)
