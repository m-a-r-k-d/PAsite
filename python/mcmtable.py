...
#    wx['Td'] = wx['Td'].astype(float)
    ...
    ax2_P.plot(tstamp_x, P(6, wx['Altim']), 'r')
    ...
    ax1.set(title = 'McMurdo Forecast %s' % today)

    fig.autofmt_xdate() #All this is doing is rotating the tick lables
    fig.set_size_inches(8,6)
    fig.tight_layout()

    fig.savefig(path+'mcm_tbl_plot.png')

if __name__=='main':
    print('main!')
    path = '/home/markd/www/static/images/'
#    path = 'C:\\Users\\owner\\Documents\\python\\PA_Get_AMPS\\'
    file = '10km.mcm.table.txt'
