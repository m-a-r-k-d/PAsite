...
IMPORTANT: In Pythonanywhere, you should put #!/usr/bin/python3.5 in the first line to
ensure that the correct version of python is being run. I had lots of problems because
pandas functions change from version to version. If I used python 2.7 (the default, i think)
the script would not import data correctly. Ugh.
"""
...
print('''This is the script that retrieves the AMPS forecasts for South Pole. It checks for the \n\r\
...
#            'mamsler@uab.edu']
        ...
        url_3km = 'http://www2.mmm.ucar.edu/rt/amps/wrf_plots/' + today1 +'00/3km/meteogram/spl.png'
        forecast_3km = 'spl_3km.png'

        url_10km = 'http://www2.mmm.ucar.edu/rt/amps/wrf_plots/'+today1+'00/10km/meteogram/spl.png'
        forecast_10km = 'spl_10km.png'
        ...
        tbl_file_10km = today1 + '00.10km.spl.table.txt'
        url_10km_tbl = 'http://www2.mmm.ucar.edu/rt/amps/wrf_plots/'+today1+'00/10km/ts_text/'+tbl_file_10km

        r = requests.get(url_10km_tbl)

        txt_file = open(path+'10km.spl.table.txt', 'w')
...
#If the loop completed and data was downloadd, make the plot of the table data.
if log[1] == 200:
    print('Creating NZ time SPL plot....')
    spltable.tbl_plot(path, '10km.spl.table.txt', today1)
    print('Done.')
